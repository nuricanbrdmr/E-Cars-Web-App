...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden rounded-full  bg-slate-800 dark:bg-slate-100">
      <SliderPrimitive.Range className="absolute h-full  bg-slate-50 dark:bg-slate-900" />
    </SliderPrimitive.Track>
    <SliderPrimitive.Thumb
      aria-label="slider-circle"
